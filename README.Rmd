...
Copy/paste that Bristle raw data.  You can either use it interactively with the function `bristler::clip_bristle_table()`  or save it to a Microsoft Excel file and read with `bristler::read_bristle_table()`. 
